...
module.exports = (app, service) => {
  ...
  route.post(`/`, entityValidator(articleKeys, entityNames.ARTICLE), (req, res) => {
  ...
  route.get(`/:articleId`, articleExists(service), (req, res) => {
  ...
  route.put(`/:articleId`, [articleExists(service), entityValidator(articleKeys, entityNames.ARTICLE)], (req, res) => {
  ...
  route.delete(`/:articleId`, articleExists(service), (req, res) => {
    const {articleId} = req.params;
  ...
  route.get(`/:articleId/comments`, articleExists(service), (req, res) => {
    const {article} = res.locals;
  ...
  route.post(`/:articleId/comments/`, [articleExists(service), entityValidator(commentKeys, entityNames.COMMENT)], (req, res) => {
    const {article} = res.locals;
  ...
  route.delete(`/:articleId/comments/:commentId`, [articleExists(service), commentExists(service), entityValidator(commentKeys, entityNames.COMMENT)], (req, res) => {
    const {article} = res.locals;
